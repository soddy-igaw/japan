...
**예약번호**: KYHYNM
**귀국일**: 5/1 **13:30** 호텔 출발 → 15:15 나리타 → 17:15 출발
...
**🍽️ 저녁 — 나카메구로/에비스 (옵션 2개)**

### 옵션 A: 야키토리 이자카야 🍗

**혼다상점 나카메구로 (本田商店)** — 한국인 블로거 압도적 추천!
- 나카메구로역 도보 3분. 야키토리+솥밥 이자카야
- 닭꼬치 5종 모듬 1,180엔, 술 무제한 2,480엔 (가성비 최고)
- 한국인 직원 있음. 분위기 좋음
- **예약**: 구글에서 예약 가능 · [구글맵](https://maps.google.com/?q=本田商店+中目黒)
- 📝 한국 블로그 후기: [후기1](https://m.blog.naver.com/newlovely211) · [후기2](https://m.blog.naver.com/sunijh97)
...
| 먹거리 | 특징 |
|---------|------|
| **카이센동 (해산물 덮밥)** | 신선한 회덮밥. 2,000엔~ |
| **타마고야키** | 츠키지 명물 계란말이. 길거리에서 바로 |
| **우니 (성게)** | 성게 군함, 크로켓 |
| **호타테 (가리비)** | 숯불 구이 가리비 |
